...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('Donatur', { // Plural
      id: {
        allowNull: false,
        primaryKey: true,
    ...
    await queryInterface.addIndex('Donatur', ['email']);
    await queryInterface.addIndex('Donatur', ['walletAddress']);
  },
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('Donatur');
  }
};